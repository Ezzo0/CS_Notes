...
- Remember with [[0x09_Segmentation|segmentation]], we had a **[[0x09_Segmentation#Segmentation Generalized Base/Bounds|base]]** register that told us where each segment lived in physical memory, and a **[[0x09_Segmentation#Segmentation Generalized Base/Bounds|bound]]** or limit register that told us the size of said segment.
